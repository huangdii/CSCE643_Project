...
class RapidEnv(robot_gazebo_env.RobotGazeboEnv):
    """Superclass for all CubeSingleDisk environments.
    """

    def __init__(self, ros_ws_abspath):
        """
        Initializes a new Rapid environment.
        Rapid doesnt use controller_manager, therefore we wont reset the
        ...
        * /scan: Laser Readings
        ...
        Args:
        """
        rospy.logdebug("Start RapidEnv initialization...")
        ...
        super(RapidEnv, self).__init__(controllers_list=self.controllers_list,
        ...
        rospy.logdebug("Finished RapidEnv initialization...")
